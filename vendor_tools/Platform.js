...
const NDKHome = "/home/jame/Android/Sdk/ndk/25.1.8937393"
...
class Platform {
    static Create(name, debug, verbose) {
        ...
        if (name === "ios") {
            return new Platform(name, ["arm64", "x64", "arm64-simulator"], debug, verbose);
        }
        if (name === "mac") {
        ...
        return new Platform(name, ["x86_64"], debug, verbose);
    }
...
class AndroidPlatform extends Platform {
    constructor(debug, verbose) {
        super("android", ["arm", "arm64","x86_64"], debug, verbose);
    ...
    getCommandPath(cmd, arch) {
        let prefix = "arm-linux-androideabi-"
        if(arch === "arm64"){
